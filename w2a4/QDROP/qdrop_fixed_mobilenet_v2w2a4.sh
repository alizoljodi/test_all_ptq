...
# PTQ Experiment: qdrop + fixed + mobilenet_v2

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: qdrop + fixed + mobilenet_v2"
echo "=========================================="

# Create results directory
mkdir -p results/qdrop_fixed_mobilenet_v2
cd results/qdrop_fixed_mobilenet_v2
...
exp_dir="qdrop_fixed_mobilenet_v2_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
