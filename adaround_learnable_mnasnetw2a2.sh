...
# PTQ Experiment: adaround + learnable + mnasnet

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: adaround + learnable + mnasnet"
echo "=========================================="

# Create results directory
mkdir -p results/adaround_learnable_mnasnet
cd results/adaround_learnable_mnasnet
...
exp_dir="adaround_learnable_mnasnet0_5_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
