...
# PTQ Experiment: adaround + fixed + MobileNetV2

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: adaround + fixed + MobileNetV2"
echo "=========================================="

# Create results directory
mkdir -p results/adaround_fixed_mbv2
cd results/adaround_fixed_mbv2
...
exp_dir="adaround_fixed_mbv2_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
