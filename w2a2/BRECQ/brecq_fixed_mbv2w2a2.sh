...
# PTQ Experiment: brecq + fixed + MobileNetV2

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: brecq + fixed + MobileNetV2"
echo "=========================================="

# Create results directory
mkdir -p results/brecq_fixed_mbv2
cd results/brecq_fixed_mbv2
...
exp_dir="brecq_fixed_mbv2_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
