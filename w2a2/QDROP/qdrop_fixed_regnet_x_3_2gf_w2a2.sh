...
# PTQ Experiment: qdrop + fixed + regnet_x_3_2gf

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: qdrop + fixed + regnet_x_3_2gf"
echo "=========================================="

# Create results directory
mkdir -p results/qdrop_fixed_regnet_x_3_2gf
cd results/qdrop_fixed_regnet_x_3_2gf
...
exp_dir="qdrop_fixed_regnet_x_3_2gf_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
