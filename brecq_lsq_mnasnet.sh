...
# PTQ Experiment: brecq + lsq + mnasnet

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: brecq + lsq + mnasnet"
echo "=========================================="

# Create results directory
mkdir -p results/brecq_lsq_mnasnet
cd results/brecq_lsq_mnasnet
...
exp_dir="brecq_lsq_mnasnet0_5_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
