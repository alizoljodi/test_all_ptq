...
# PTQ Experiment: adaround + lsqplus + resnet18

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: adaround + lsqplus + resnet50"
echo "=========================================="

# Create results directory
mkdir -p results/adaround_lsqplus_resnet50
cd results/adaround_lsqplus_resnet50
...
exp_dir="adaround_lsqplus_resnet50_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
