...
# Run MQBench PTQ experiments for MobileNet V2
# Loops through different alpha, num_clusters, and pca_dim values

echo "🚀 Starting MobileNet V2 PTQ experiments..."
echo "=========================================="

# Create results directory
mkdir -p results/mobilenet_v2
cd results/mobilenet_v2
...
echo ""
echo "🎉 All MobileNet V2 experiments completed!"
