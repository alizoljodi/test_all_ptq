...
# PTQ Experiment: adaround + fixed + resnet18

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: adaround + fixed + resnet18"
echo "=========================================="

# Create results directory
mkdir -p results/adaround_fixed_resnet18
cd results/adaround_fixed_resnet18
...
exp_dir="adaround_fixed_resnet18_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
