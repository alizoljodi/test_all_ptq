...
# PTQ Experiment: qdrop + learnable + mnasnet

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: qdrop + learnable + mnasnet"
echo "=========================================="

# Create results directory
mkdir -p results/qdrop_learnable_mnasnet
cd results/qdrop_learnable_mnasnet
...
exp_dir="qdrop_learnable_mnasnet0_5_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
