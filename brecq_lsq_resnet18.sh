...
# PTQ Experiment: brecq + lsq + resnet18

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: brecq + lsq + resnet18"
echo "=========================================="

# Create results directory
mkdir -p results/brecq_lsq_resnet18
cd results/brecq_lsq_resnet18
...
exp_dir="brecq_lsq_resnet18_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
