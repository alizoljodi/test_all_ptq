...
# PTQ Experiment: brecq + fixed + mnasnet0_5

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: brecq + fixed + mnasnet0_5"
echo "=========================================="

# Create results directory
mkdir -p results/brecq_fixed_mnasnet
cd results/brecq_fixed_mnasnet
...
exp_dir="brecq_fixed_mnasnet_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
