...
# PTQ Experiment: brecq + fixed + resnet18

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: brecq + fixed + resnet50"
echo "=========================================="

# Create results directory
mkdir -p results/brecq_fixed_resnet50
cd results/brecq_fixed_resnet50
...
exp_dir="brecq_fixed_resnet50_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
