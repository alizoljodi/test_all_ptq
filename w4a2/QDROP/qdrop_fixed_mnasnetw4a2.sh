...
# PTQ Experiment: qdrop + fixed + mnasnet0_5

# Activate MQBench environment
source /home/alz07xz/project/kmeans_results/MQBench/mqbench/bin/activate

echo "🚀 Starting PTQ Experiment: qdrop + fixed + mnasnet0_5"
echo "=========================================="

# Create results directory
mkdir -p results/qdrop_fixed_mnasnet
cd results/qdrop_fixed_mnasnet
...
exp_dir="qdrop_fixed_mnasnet_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$exp_dir"
